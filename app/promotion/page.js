        ...
        <div className="rounded-2xl border bg-white p-5 shadow-sm">
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 space-y-5 text-sm leading-7 text-gray-700">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">
                  ควรใช้คำว่า สติกเกอร์ไลน์ หรือ สติ๊กเกอร์ไลน์?
                </h3>
                <p>
                  คำที่ใช้เป็นทางการมักเขียนว่า “สติกเกอร์ไลน์”
                  แต่หลายคนค้นหาด้วยคำว่า “สติ๊กเกอร์ไลน์”
                  หน้านี้จึงใช้ทั้งสองคำเพื่อให้ค้นหาเจอได้ง่ายขึ้น
                </p>
              </div>
            </div>
          </div>
