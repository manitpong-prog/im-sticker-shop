...
async function runScraper() {
  ...
  const targets = [
    {
      name: 'สติกเกอร์ทางการมาใหม่',
      url: 'https://store.line.me/stickershop/showcase/new/th',
      type: 'sticker',
      category: 'official_sticker',
      is_new_sticker_official: true,
      is_new_emoji_official: false,
      is_new_theme_official: false
    },
    {
      name: 'สติกเกอร์ทางการสุดฮิต',
      url: 'https://store.line.me/stickershop/showcase/top/th',
      type: 'sticker',
      category: 'official_sticker',
